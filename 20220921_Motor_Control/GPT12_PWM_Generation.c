...
#define PWM_FREQUENCY               486.529                    /* Frequency of the PWM signal in Hz                    */
...
void initGpt12PWM(void)
{
    ...
    IfxPort_setPinModeOutput(ENA, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
}
